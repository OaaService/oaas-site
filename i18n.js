...
(function () {
  const dict = {
    en: {
      ...
      "sentinel.status": "Live", "bw.status": "Coming to Google Play", "bw.offline": "100% offline", "bw.privacy": "Privacy policy",
    ...
    fr: {
      ...
      "sentinel.status": "En ligne", "bw.status": "Bientôt sur Google Play", "bw.offline": "100 % hors ligne", "bw.privacy": "Confidentialité",
