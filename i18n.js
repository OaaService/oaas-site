...
(function () {
  const dict = {
    en: {
      ...
      "tl.meta": "open source · GPL-3", "tl.p": "Secret manager for teams. A place to store, organise and share passwords, keys and credentials — encrypted on your side, hosted on your infrastructure.",
      "tl.p2": "Every user holds an RSA key pair; each workspace gets its own AES-256 key, sealed with the members' public keys. Nothing readable ever leaves your servers, and the full usage history tells you who opened what, and when.",
      "tl.more": "Workspaces and folders · multi-factor authentication · granular sharing · external sharing by email or SMS · KeePass import · extensions for Chrome, Edge and Opera · mobile app",
      "tl.docs": "Documentation",
    ...
    fr: {
      ...
      "tl.meta": "open source · GPL-3", "tl.p": "Gestionnaire de secrets pour les équipes. Un endroit pour stocker, organiser et partager mots de passe, clés et identifiants — chiffrés de votre côté, hébergés sur votre infrastructure.",
      "tl.p2": "Chaque utilisateur détient une paire de clés RSA ; chaque espace de travail a sa propre clé AES-256, scellée avec les clés publiques de ses membres. Rien de lisible ne sort jamais de vos serveurs, et l'historique complet dit qui a ouvert quoi, et quand.",
      "tl.more": "Espaces de travail et dossiers · authentification multi-facteurs · partage granulaire · partage externe par email ou SMS · import KeePass · extensions Chrome, Edge et Opera · application mobile",
      "tl.docs": "Documentation",
