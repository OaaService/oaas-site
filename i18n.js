...
(function () {
  const dict = {
    en: {
      "nav.solutions": "Solutions", "nav.approach": "Approach", "nav.studio": "Studio", "nav.contact": "Contact",
      "hero.eyebrow": "Independent software studio · France",
      "hero.title": "Software that does one thing, and does it well.",
      ...
      "sentinel.tag": "Monitoring for SaaS & Kubernetes",
      "sentinel.desc": "<strong>Know when your services break.</strong> Sentinel aggregates health signals from any system — Prometheus, Grafana, Datadog, Kubernetes — and alerts instantly via Slack, email or webhook. Automatic service discovery, infrastructure mapping, rollout detection.",
      "sentinel.chip4": "Freemium", "sentinel.cta": "sentinel-app.io →",
      "bw.tag": "Baby monitor for Wear OS watches",
      "bw.desc": "<strong>Forgot the baby monitor? Your watch is enough.</strong> The watch listens to the room, your phone gets the alert — over Bluetooth, no account, no server, no subscription. Auto-calibrated cry detection, live listening, talk-back, white noise and lullaby, lost-link alarm.",
    ...
    fr: {
      "nav.solutions": "Solutions", "nav.approach": "Approche", "nav.studio": "Studio", "nav.contact": "Contact",
      "hero.eyebrow": "Studio logiciel indépendant · France",
      "hero.title": "Des solutions logicielles qui font une chose, et la font bien.",
      ...
      "hero.cta1": "Découvrir les solutions", "hero.cta2": "Nous écrire",
      "sol.title": "Solutions", "sol.sub": "Deux produits, deux mondes, une même philosophie.",
      "sentinel.tag": "Monitoring pour SaaS & Kubernetes",
      "sentinel.desc": "<strong>Know when your services break.</strong> Sentinel agrège les signaux de santé de n'importe quel système — Prometheus, Grafana, Datadog, Kubernetes — et alerte instantanément via Slack, email ou webhook. Découverte automatique des services, cartographie d'infrastructure, détection des rollouts.",
      "sentinel.chip4": "Freemium", "sentinel.cta": "sentinel-app.io →",
      "bw.tag": "Babyphone pour montre Wear OS",
      "bw.desc": "<strong>Babyphone oublié ? Ta montre suffit.</strong> La montre écoute la chambre, le téléphone t'alerte — en Bluetooth, sans compte, sans serveur, sans abonnement. Détection des pleurs auto-calibrée, écoute en direct, talk-back, bruit blanc et berceuse, alerte de liaison perdue.",
