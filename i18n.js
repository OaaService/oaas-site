...
(function () {
  const dict = {
    en: {
      ...
      "tl.tag": "Enterprise secret manager.", "tl.desc": "Store, manage and share your company's secrets securely. RSA + AES-256 encryption per workspace, MFA, granular and external sharing, KeePass import, browser extensions, full usage history. Open source, security by design.", "tl.status": "Live", "tl.meta": "Open source · Self-hosted",
      "tl.p2": "Every user holds an RSA key pair; each workspace gets its own AES-256 key, sealed with the members' public keys. Nothing readable ever leaves your servers, and the full usage history tells you who opened what, and when.", "tl.more": "Workspaces and folders · multi-factor authentication · granular sharing · external sharing by email or SMS · KeePass import · extensions for Chrome, Edge and Opera · mobile app", "tl.docs": "Documentation",
      "sentinel.status": "Live", "sentinel.docs": "Documentation", "bw.status": "Coming to Google Play", "bw.offline": "100% offline", "bw.privacy": "Privacy policy",
    ...
    fr: {
      ...
      "tl.tag": "Gestionnaire de secrets d'entreprise.", "tl.desc": "Stockez, gérez et partagez en toute sécurité les secrets de votre entreprise. Chiffrement RSA + AES-256 par espace de travail, MFA, partage granulaire et externe, import KeePass, extensions navigateur, historique d'utilisation complet. Open source, sécurité par conception.", "tl.status": "En ligne", "tl.meta": "Open source · Auto-hébergé",
      "tl.p2": "Chaque utilisateur détient une paire de clés RSA ; chaque espace de travail a sa propre clé AES-256, scellée avec les clés publiques de ses membres. Rien de lisible ne sort jamais de vos serveurs, et l'historique complet dit qui a ouvert quoi, et quand.", "tl.more": "Espaces de travail et dossiers · authentification multi-facteurs · partage granulaire · partage externe par email ou SMS · import KeePass · extensions Chrome, Edge et Opera · application mobile", "tl.docs": "Documentation",
      "sentinel.status": "En ligne", "sentinel.docs": "Documentation", "bw.status": "Bientôt sur Google Play", "bw.offline": "100 % hors ligne", "bw.privacy": "Confidentialité",
